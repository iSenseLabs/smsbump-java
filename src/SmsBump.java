...
public class SmsBump implements Runnable {
    ...
    public static enum Method {
        ...
        public String getString() { return method; }
    }
	...
	public void setCallback(SmsBumpRunnable callback) { this.callback = callback; }

    public void clearRecipients() { to.clear(); }

    public void addRecipient(String recipient) { to.add(recipient); }

    public void addRecipients(String[] recipients) { to.addAll(Arrays.asList(recipients)); }

	public String[] getResponses() { return responses.toArray(new String[responses.size()]); }
	...
	private String getApiUrl() { return "http://api.smsbump.com/" + method.getString() + "/" + APIKey + ".json"; }
}